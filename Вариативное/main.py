...
"""
plt.scatter(x, y, marker = "*", c ='black', label = u'Данные из файла')
...
plt.plot(x1, func3(x1), c ='red', label = u'Изображение полинома 3-ей степени')
func4 = np.poly1d(np.polyfit(numpy_x, numpy_y, 4))
plt.plot(x1, func4(x1), c ='blue', label = u'Изображение полинома 4-ой степени')
func10 = np.poly1d(np.polyfit(numpy_x, numpy_y, 10))
plt.plot(x1, func10(x1), c ='green', label = u'Изображение полинома 10-ой степени')

plt.title('Задание 4.1. Полиномиальный график')
